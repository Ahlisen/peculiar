...
package se.peculiar.googleplaydownloaderlibrary;
...
//            if ( !c.bindService(bindIntent, mConnection, Context.BIND_IMPORTANT) ) {
//                if ( Constants.LOGVV ) {
...
//            }
            ...
            c.bindService(bindIntent, mConnection, Context.BIND_IMPORTANT);
            mBound = true;
        }
